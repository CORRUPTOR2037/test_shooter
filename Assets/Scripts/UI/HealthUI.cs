...
public class HealthUI : MonoBehaviour
{
    ...
    private void RecreateIcons(int newSize)
    {
        ...
        while (pointIcons.Count < newSize)
        {
            Image icon = UnityEngine.Object.Instantiate(iconPrefab, iconPrefab.rectTransform.parent);
            pointIcons.Add(icon);
        }
